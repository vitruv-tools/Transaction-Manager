...
public class CommonCreatorClasses {
  ...
  static RemoveRootEObject<EObject> getRemoveRootEObjectChange(EObject obj) {
    return E_CHANGE_FACTORY
        .createRemoveRootChange(obj, obj.eResource(), 0);
  }
  ...
  static TransactionalChangeImpl<EObject> createTransactionFrom(List<EChange<EObject>> originalChanges) {
